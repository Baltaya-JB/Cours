(function() {
  ...
  const IGNORE = new Set(['HTML','HEAD','SCRIPT','STYLE','LINK','META','SVG','IFRAME','CANVAS','INPUT','SELECT','OPTION','LABEL','VIDEO','AUDIO']);
  ...
  function drawDebugOverlay() {
    ...
    for (const el of all) {
      try {
        ...
        // marge
        ctx.fillStyle = 'rgba(214, 0, 0, 0.09)';
        ctx.strokeStyle = 'rgba(214, 0, 0, 0)';
        ctx.lineWidth = 1;
        ...
        // padding
        ctx.fillStyle = 'rgba(0, 214, 0, 0.06)';
        ctx.strokeStyle = 'rgba(0, 214, 0, 0)';
        ctx.lineWidth = 0.5;
